...
INSERT INTO plan_unidad (titulo_unidad, objetivos, contenidos, criterios_evaluacion, destrezas, fecha_inicio, fecha_fin, observaciones, id_unidad, id_empleado, id_asignatura, id_modalidad, id_periodo, estado, id_curso) values ('Algebra', 'Objetivo1', 'Contenido1', 'Criterio1', 'Destreza1', '01-09-2022', '30-06-2023', 'Sin observaciones', 1, 8, 2, 1, 1, 'Pendiente', 1);
