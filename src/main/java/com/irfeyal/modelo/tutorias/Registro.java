...
private static final long serialVersionUID = 1L;
	...
	public Registro(Long id_registro, float aporte1, float aporte2, float examen_Iquimestre, float promedio_Iquimestre,
			float aporte3, float aporte4, float examen_IIquimestre, float promedio_IIquimestre,float conducta, float nota_final,
			float examen_supletorio, float examen_remedial, float examen_gracia, String estado) {
		super();
