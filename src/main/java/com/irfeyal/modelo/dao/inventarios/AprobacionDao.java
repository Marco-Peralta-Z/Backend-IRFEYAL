...
public interface AprobacionDao extends CrudRepository<Aprobacion, Long> {
	...
	@Query(
			value = "select apr.observacion_aproba, apr.detalle_control, apr.fecha_aprobacion, r.descripcion, (p.nombre || ' ' ||p.apellido) as administrador,\r\n"
