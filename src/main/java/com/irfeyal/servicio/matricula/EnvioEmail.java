	...
	private static final BaseColor color= new BaseColor(19, 63, 120 );
	 public void sendEmail(String to, String nombre) {
	        ...
	        content="<!doctype html>\r\n"
	        		...
	        		+ "                                                                        matricula ha sido realizada con exito.</p>\r\n"
	        		+ "                                                                </td>\r\n"
	        		+ "                                                            </tr>\r\n"
	        		+ "                                                            <tr>\r\n"
...
//			  
			   ...
			   celda0.setHorizontalAlignment(1);
			   document.add(titulo);
			   
			   document.add(new Paragraph("Cedula: "+ datosMatricula.getEstudiante().getId_persona().getCedula()));
			   document.add(new Paragraph("Apellidos/Nombres: "+ (datosMatricula.getEstudiante().getId_persona().getApellido() +" "+ datosMatricula.getEstudiante().getId_persona().getNombre()).toUpperCase()));
			   document.add(new Paragraph("Fecha de Matricula: "+ datosMatricula.getFechaMatricula().toString()));
			   document.add(Chunk.NEWLINE);
			   
			   Paragraph texto= new Paragraph("IRFEYAL le da la bienvenida a una nueva meta en su vida; acontinuación se detalla la información de su matricula.");
