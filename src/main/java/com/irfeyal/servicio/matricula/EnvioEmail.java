...
//			    final InputStreamSource attachment = new ByteArrayResource(stream.toByteArray());
	 ...
	 private ByteArrayOutputStream createInMemoryDocument(Matricula datosMatricula) {
		   try(ByteArrayOutputStream bos= new ByteArrayOutputStream()){
			   ...
			   String localDir = this.getClass().getClassLoader().
			   ...
			   PdfPTable tabla = new PdfPTable(2);
	            ...
	            PdfPCell celda3 = new PdfPCell(new Phrase(datosMatricula.getId_periodo().getPeriodo_academico()));
...
//			   document.add(logo);
			   ...
			   document.add(new Paragraph("FECHA Y HORA DE MATRICULA: "+ formatter.format(datosMatricula.getFechaMatricula())));
			   document.add(Chunk.NEWLINE);
			   document.add(Chunk.NEWLINE);
			   
			   Paragraph texto= new Paragraph();
			   Chunk textPart1= new Chunk("IRFEYAL",bold);
			   Chunk textPart2= new Chunk(" le da la bienvenida a una nueva meta en su vida; acontinuación se detalla la información de su matricula.");
			   texto.add(textPart1);
			   texto.add(textPart2);
