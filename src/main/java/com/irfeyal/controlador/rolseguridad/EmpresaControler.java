...
import com.irfeyal.servicio.rolseguridad.EmpresaInterface;
...
public class EmpresaControler {
	...
	public ResponseEntity<?> delete(@PathVariable Long id) {
		...
		try {
			Empresa empresaNew =empresaService.findById(id);
			empresaService.deleteEmpresa();
		} catch (DataAccessException e) {
			response.put("mensaje", "Erros al eliminar la empresa de la base de datos");
