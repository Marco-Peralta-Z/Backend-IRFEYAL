...
public class RegistroController {
	...
	//eliminar un registro por id
		...
		public ResponseEntity<?> getRegisrosByCursoModalidadPeriodo(@PathVariable("idCurso") Long idCurso, @PathVariable("idMod") Long idMod ,@PathVariable("idPer") Long idPer) {
			List<Registro> registros= null;
			Map <String, Object> response =new HashMap<>();
			try {
