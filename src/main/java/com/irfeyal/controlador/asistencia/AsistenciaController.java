...
public ResponseEntity<?> createclase(@Validated @RequestBody Clase asistencia, BindingResult result) {
	...
	public List<Estudiante> filtros(@PathVariable Long idmod,@PathVariable Long idper,@PathVariable Long idpar,@PathVariable Long idasig ,@PathVariable Long idcurs){
