...
public interface IAsistenciaService {
	...
	public @NotNull ResponseEntity<ByteArrayResource> exportInvoice(Long id_estudiante,Long iddocente,Long idasignatura, Long usuario,Date fechainicio,Date fechafin);
	public @NotNull ResponseEntity<ByteArrayResource> exportInvoicepdfcursos(Long id_mod, Long id_periodo, Long id_paralelo, Long id_asignatura,Long id_curso,Long docente, Long usuario,Date fechainicio,Date fechafin);
}
